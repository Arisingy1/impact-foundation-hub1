  ...
  >
    <defs>
      <linearGradient id="heroGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="35%" stopColor="#1e2a4a" />
        <stop offset="65%" stopColor="#222f52" />
      ...
      <radialGradient id="heroGlowBottom" cx="50%" cy="100%" r="60%">
        <stop offset="0%" stopColor="#131d35" stopOpacity="0.5" />
        <stop offset="100%" stopColor="#131d35" stopOpacity="0" />
      </radialGradient>
      {/* Blob shapes */}
      <radialGradient id="blob1" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#3a5080" stopOpacity="0.35" />
