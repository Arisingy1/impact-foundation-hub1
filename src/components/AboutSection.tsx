          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <div className="flex items-start gap-4 bg-white/[0.04] rounded-2xl p-5 border border-white/[0.06]">
                ...
                <div>
                  <blockquote className="font-display text-base md:text-lg italic text-primary-foreground/85 leading-relaxed mb-2">
                    «Каждый проект — это инвестиция в будущее. Не финансовая, а человеческая.»
                  </blockquote>
                  <p className="font-body text-xs text-primary-foreground/65">
