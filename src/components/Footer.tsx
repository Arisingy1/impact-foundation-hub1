      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
        <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-12 mb-14">
          <div>
            ...
            <p className="font-body text-sm text-primary-foreground/70 leading-relaxed max-w-xs mb-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-primary-foreground/5 border border-primary-foreground/10 flex items-center justify-center text-primary-foreground/60 hover:text-accent hover:border-accent/30 transition-colors"
              >
          ...
          <div>
            <h5 className="font-body text-[11px] uppercase tracking-[0.25em] text-accent/80 mb-5 font-medium">Навигация</h5>
          ...
          <div>
            <h5 className="font-body text-[11px] uppercase tracking-[0.25em] text-accent/80 mb-5 font-medium">Контакты</h5>
