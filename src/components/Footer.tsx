    ...
    <footer className="section-dark relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
        <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-12 mb-14">
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center text-white/50 hover:text-[#9b6dff] hover:border-[#9b6dff]/30 transition-colors"
              >
          ...
          <div>
            <h5 className="font-body text-[11px] uppercase tracking-[0.25em] text-[#9b6dff]/70 mb-5 font-medium">Навигация</h5>
