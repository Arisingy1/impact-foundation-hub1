...
const stats = [
  { value: 120, suffix: "+", label: "Проектов реализовано", icon: Target, color: "from-amber-500/20 to-amber-600/5" },
  { value: 15000, suffix: "+", label: "Участников мероприятий", icon: Users, color: "from-emerald-500/20 to-emerald-600/5" },
  { value: 25, suffix: "", label: "Регионов России", icon: MapPin, color: "from-blue-500/20 to-blue-600/5" },
  { value: 80, suffix: "+", label: "Событий проведено", icon: Calendar, color: "from-purple-500/20 to-purple-600/5" },
];
