            ...
            >
              ...
              <div className="sticky top-0 bg-card/95 backdrop-blur-xl rounded-t-3xl border-b border-border px-6 py-5 flex items-center justify-between z-10">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#4d7cff]/15 flex items-center justify-center">
                    <Heart className="w-5 h-5 text-[#4d7cff]" />
                  </div>
                  <div>
              ...
              <div className="px-6 py-6 space-y-6">
                {/* Info text */}
                <div className="bg-[#4d7cff]/5 border border-[#4d7cff]/15 rounded-2xl p-4">
